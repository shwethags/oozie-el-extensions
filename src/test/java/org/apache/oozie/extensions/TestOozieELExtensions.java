...
public class TestOozieELExtensions {
    ...
    public void testDataIn() throws Exception {
        ...
        assertEquals(expuris, CoordELFunctions.evalAndWrap(eval, "${elext:dataIn('clicks', '*/US')}"));
    }
    ...
    public void testTodayOffset() throws Exception {
        ...
        String instResult = CoordELFunctions.evalAndWrap(instEval, expr);
        assertEquals("2009-09-02T02:00Z", CoordELFunctions.evalAndWrap(createEval, getELExpression(instResult)));
        ...
        expr = "${elext:todayWithOffset(2,0,-240)}";
        instResult = CoordELFunctions.evalAndWrap(instEval, expr);
        assertFalse("2009-09-02T02:00Z".equals(CoordELFunctions.evalAndWrap(createEval, getELExpression(instResult))));
    }
